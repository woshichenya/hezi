...
#门店id
sql="SELECT id FROM plus_store WHERE user_id  in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')"
#或者
sql="SELECT COUNT(id),city FROM plus_store WHERE group_id ='1016'"
#店铺id
sql="SELECT id FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')"
#今天商品信息
...
#店铺数量：
sql="SELECT COUNT(id) FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')"
all_shop_sum=sql_go.lianjie_sql("plus2test",sql)
print("店铺数量",int(all_shop_sum[0][0]))
#小程序店铺数量：
sql="SELECT COUNT(id) FROM plus_shop_info WHERE type = '1' AND user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')"
xiao_shop_sum=sql_go.lianjie_sql("plus2test",sql)
print("小程序店铺数量",int(xiao_shop_sum[0][0]))
#公众号店铺数量：
sql="SELECT COUNT(id) FROM plus_shop_info WHERE type = '2' AND user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')"
...
#店铺城市
sql="SELECT m.type,u.city FROM plus_shop_info as m INNER JOIN plus_users as u on m.user_id = u.user_id where u.group_id = '1016' GROUP BY m.type,u.city"
all_shop_city=sql_go.lianjie_sql("plus2test",sql)
print("店铺城市",all_shop_city)
sql="SELECT * FROM `plus_users` WHERE group_id = '1016' GROUP BY city"
...
#平均每小时销售额：
sql="SELECT SUM(sale_prices)/14 FROM `plus_shop_sale_count_hour` where `hour` < '14' AND create_date = '2019-01-17' AND uniacid in ("+sql_gzh_id_list+")"
all_goods_mai_h=sql_go.lianjie_sql("plus2test",sql)
print("2019-01-17--14:00的每小时销售额数据\t",float(all_goods_mai_h[0][0]))
#小程序+今天销售额
...
print("公众号今天店铺销售额数据\t",wxapp_goods_mai_new_f)
#昨天销售额
...
wxapp_goods_mai_old_f=float(wxapp_goods_mai_old[0][0])
print("公众号昨天店铺销售数据\t",wxapp_goods_mai_old_f)
if float(wxapp_goods_mai_new[0][0]) + float(xiao_goods_mai_new[0][0]) == float(all_goods_mai_new[0][0]) and float(wxapp_goods_mai_old[0][0]) + float(xiao_goods_mai_old[0][0]) ==float(all_goods_mai_old[0][0]) :
...
#店铺商品数量：
#今天商品数量：
sql="SELECT SUM(goods_sum) FROM plus_shop_realtime_data WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
all_goods_sum_new=sql_go.lianjie_sql("plus2test",sql)
print("今天店铺商品数量\t",float(all_goods_sum_new[0][0]))
#昨日商品数量：
sql="SELECT SUM(goods_sum) FROM plus_shop_sale_visit WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
all_goods_sum_old=sql_go.lianjie_sql("plus2test",sql)
print("昨日店铺商品数量\t",float(all_goods_sum_old[0][0]))
#小程序+今天商品数量：
sql="SELECT SUM(goods_sum) FROM plus_shop_realtime_data WHERE type = '1' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
xiao_goods_sum_new=sql_go.lianjie_sql("plus2test",sql)
print("小程序今天店铺商品数量\t",float(xiao_goods_sum_new[0][0]))
#公众号+今天商品数量：
sql="SELECT SUM(goods_sum) FROM plus_shop_realtime_data WHERE type = '2' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
wxapp_goods_sum_new=sql_go.lianjie_sql("plus2test",sql)
print("公众号今天店铺商品数量\t",float(wxapp_goods_sum_new[0][0]))
#小程序+昨日商品数量：
sql="SELECT SUM(goods_sum) FROM plus_shop_sale_visit WHERE type = '1' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
xiao_goods_sum_old=sql_go.lianjie_sql("plus2test",sql)
print("小程序昨日店铺商品数量\t",float(xiao_goods_sum_old[0][0]))
#公众号+昨日商品数量：
sql="SELECT SUM(goods_sum) FROM plus_shop_sale_visit WHERE type = '2' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
wxapp_goods_sum_old=sql_go.lianjie_sql("plus2test",sql)
print("公众号昨日店铺商品数量\t",float(wxapp_goods_sum_old[0][0]))

if int(wxapp_goods_sum_old[0][0]) + int(xiao_goods_sum_old[0][0]) == int(all_goods_sum_old[0][0]) and int(wxapp_goods_sum_new[0][0]) + int(xiao_goods_sum_new[0][0]) == int(all_goods_sum_new[0][0]):
...
#店铺访问量：
#今天：
sql="SELECT SUM(visit_person_sum) FROM plus_shop_realtime_data WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
all_visit_sum_new=sql_go.lianjie_sql("plus2test",sql)
all_visit_sum_new_f=float(all_visit_sum_new[0][0])
print("今天店铺访问量\t",all_visit_sum_new_f)
#昨日：
sql="SELECT SUM(visit_person_sum) FROM plus_shop_sale_visit WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
all_visit_sum_old=sql_go.lianjie_sql("plus2test",sql)
all_visit_sum_old_f=float(all_visit_sum_old[0][0])
print("昨日店铺访问量\t",all_visit_sum_old_f)
#小程序+今天：
sql="SELECT COUNT(uniacid) FROM plus_shop_realtime_data WHERE type = '1' AND uniacid in (SELECT uniacid FROM plus_shop_info WHERE  type='1' and user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016') )"
xiao_visit_sum_new=sql_go.lianjie_sql("plus2test",sql)
print("小程序今天店铺访问量\t",float(xiao_visit_sum_new[0][0]))
#公众号+今天：
sql="SELECT COUNT(uniacid) FROM plus_shop_realtime_data WHERE type = '2' AND uniacid in (SELECT uniacid FROM plus_shop_info WHERE  type='1' and user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016') )"
wxapp_visit_sum_new=sql_go.lianjie_sql("plus2test",sql)
print("公众号今天店铺访问量\t",float(wxapp_visit_sum_new[0][0]))
#小程序+昨日：
sql="SELECT SUM(visit_person_sum) FROM plus_shop_sale_visit WHERE type = '1' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
xiao_visit_sum_old=sql_go.lianjie_sql("plus2test",sql)
print("小程序昨日店铺访问量\t",float(xiao_visit_sum_old[0][0]))
#公众号+昨日：
sql="SELECT SUM(visit_person_sum) FROM plus_shop_sale_visit WHERE type = '2' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))"
wxapp_visit_sum_old=sql_go.lianjie_sql("plus2test",sql)
print("公众号昨日店铺访问量\t",float(wxapp_visit_sum_old[0][0]))
#小程序+昨日+分析：
sql="SELECT create_date,SUM(visit_person_sum) FROM plus_shop_sale_visit WHERE type = '1' AND uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` WHERE group_id ='1016'))GROUP BY create_date"
...
print("小程序累计访问人数：\t",float(xiao_visit_sum_new[0][0])+float(xiao_visit_sum_old[0][0]),"\t人")
print("公众号累计访问人数：\t",float(wxapp_visit_sum_new[0][0])+float(wxapp_visit_sum_old[0][0]),"\t人")

#小程序数据汇总：
sql="SELECT SUM(session_cnt) as '打开次数',SUM(visit_uv_new) as '新增访问人数',SUM(visit_total) as '累计用户数' ,SUM(share_uv) as '转发人数' FROM `plus_wxapp_visit` WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM plus_users WHERE group_id ='1016'))and create_date = '2019-01-17'"
xiao_all_fenxi=sql_go.lianjie_sql("plus2test",sql)
for xiao_all_fenxi_x in xiao_all_fenxi:
    print("\t小程序打开次数\t",xiao_all_fenxi_x[0],"\t小程序新增访问人数\t",xiao_all_fenxi_x[1],"\t小程序累计用户数\t",xiao_all_fenxi_x[2],"\t小程序转发人数\t",xiao_all_fenxi_x[3])
#小程序数据排行汇总：
sql="SELECT uniacid,session_cnt as '打开次数',visit_uv_new as '新增访问人数',visit_total as '累计用户数' ,share_uv as '转发人数' FROM `plus_wxapp_visit` WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM plus_users WHERE group_id ='1016'))and create_date = '2019-01-17' ORDER BY visit_total DESC "
xiao_all_fenxi=sql_go.lianjie_sql("plus2test",sql)
paiming_xiaochengxu_fangwen=0
for xiao_all_fenxi_x in xiao_all_fenxi:
    sql="SELECT `name`,city FROM `plus_users` WHERE user_id in (SELECT user_id FROM `plus_shop_info` WHERE uniacid ='"+xiao_all_fenxi_x[0]+"')"
    xiao_all_fenxi_guishudi = sql_go.lianjie_sql("plus2test", sql)
    paiming_xiaochengxu_fangwen += 1
    print("第%s名"%paiming_xiaochengxu_fangwen,"\t小程序id\t",xiao_all_fenxi_x[0],"\t小程序打开次数\t",xiao_all_fenxi_x[1],"\t小程序新增访问人数\t",xiao_all_fenxi_x[2],"\t小程序累计用户数\t",xiao_all_fenxi_x[3],"\t小程序转发人数\t",xiao_all_fenxi_x[4],"\t归属地：\t",xiao_all_fenxi_guishudi[0][1],"\t小程序负责人：\t",xiao_all_fenxi_guishudi[0][0])
    if paiming_xiaochengxu_fangwen >=10:
        break
#小程序数据补充：
sql="SELECT create_date,SUM(visit_total) as '累计用户数',SUM(visit_uv) as '访问人数visit_uv相加',SUM(`visit_pv`) as '访问次数',SUM(`visit_uv_new`) as  '新增访问人数',AVG (stay_time_uv) as '人均停留 （秒）',AVG (stay_time_session) as '均次停留 （秒）' FROM `plus_wxapp_visit` WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM plus_users WHERE group_id ='1016'))GROUP BY create_date  "
xiao_all_fenxi_buchong=sql_go.lianjie_sql("plus2test",sql)
paiming_xiaochengxu_fangwen=0
for xiao_all_fenxi_x_buchong in xiao_all_fenxi_buchong:
    print("\t日期：\t", xiao_all_fenxi_x_buchong[0], "\t小程序累计用户数\t", xiao_all_fenxi_x_buchong[1], "\t小程序访问人数visit_uv相加\t",xiao_all_fenxi_x_buchong[2], "\t小程序访问次数\t", xiao_all_fenxi_x_buchong[3], "\t小程序新增访问人数\t",xiao_all_fenxi_x_buchong[4], "\t小程序人均停留 （秒）\t",xiao_all_fenxi_x_buchong[5],"\t小程序均次停留 （秒）\t",xiao_all_fenxi_x_buchong[6])
...
print("公众号今日订单数量有:\t%s\t个"%wxapp_order_sum_new_i)
#小程序昨日订单数量
...
print("公众号昨日订单数量有:\t%s\t个"%wxapp_order_sum_old_i)
...
all_zhifu_sum_new_f=float(all_zhifu_sum_new[0][0])
...
all_zhifu_sum_old_f=float(all_zhifu_sum_old[0][0])
...
xiao_zhifu_sum_new_f=float(xiao_zhifu_sum_new[0][0])
...
wxapp_zhifu_sum_new_f=float(wxapp_zhifu_sum_new[0][0])
print("公众号今日支付人数:\t%s\t个"%wxapp_zhifu_sum_new_f)
#小程序昨日支付人数
...
print("公众号昨日支付人数:\t%s\t个"%wxapp_zhifu_sum_old_f)
...
wxapp_zhifu_sum_old=sql_go.lianjie_sql("plus2test",sql)
wxapp_zhifu_sum_old_f=float(wxapp_zhifu_sum_old[0][0])
print("公众号今日新增支付人数:\t%s\t个"%wxapp_zhifu_sum_old_f)
...
#门店销售额Top10
#有时间的
sql="SELECT a.uniacid,if(a.type='1','小程序','公众号'),sum(a.sale_prices) FROM `plus_shop_sale_visit` as a where create_date >= '2019-01-15' AND create_date <= '2019-01-16' AND a.uniacid in ("+sql_gzh_id_list+") GROUP BY a.uniacid,a.type ORDER BY SUM(a.sale_prices) DESC "
...
new_guanzhu=sql_go.lianjie_sql("plus2test",sql)
new_guanzhu_f=float(new_guanzhu[0][0])
print("2019年新增关注人数：\t",new_guanzhu_f,"\t人")
...
print("取消关注人数：\t",quxiao_guanzhu_f,"\t人")
...
quxiao_guanzhu=sql_go.lianjie_sql("plus2test",sql)
quxiao_guanzhu_f=float(quxiao_guanzhu[0][0])
print("2019年取消关注人数：\t",quxiao_guanzhu_f,"\t人")
...
print("累计关注人数：\t",leiji_guanzhu_f,"\t人")
...
leiji_guanzhu=sql_go.lianjie_sql("plus2test",sql)
leiji_guanzhu_f=float(leiji_guanzhu[0][0])
print("2019年累计关注人数：\t",leiji_guanzhu_f,"\t人")
...
print("净增关注人数：\t",jingzeng_guanzhu_f,"\t人")
...
jingzeng_guanzhu=sql_go.lianjie_sql("plus2test",sql)
jingzeng_guanzhu_f=float(jingzeng_guanzhu[0][0])
print("2019年净增关注人数：\t",jingzeng_guanzhu_f,"\t人")
#
sql="SELECT create_date,SUM(new_user) as '新增关注' FROM `plus_wechats_member_analysis` WHERE uniacid in (SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')) GROUP BY create_date"
...
#昨日关键指标
sql="SELECT SUM(cumulate_user) as '累积用户',SUM(new_user) as '新增用户',SUM(cancel_user) as '取消用户',SUM(incr_user) as '净增关注' FROM `plus_wechats_member_analysis` WHERE create_date >= '2019-01-20' AND   uniacid in (SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016'))"
zuori_shuju_tongji=sql_go.lianjie_sql("plus2test",sql)
print("昨日关键指标：")
print("累计用户\t",zuori_shuju_tongji[0][0],"\t新增用户\t",zuori_shuju_tongji[0][1],"\t取消用户\t",zuori_shuju_tongji[0][2],"\t净增关注\t",zuori_shuju_tongji[0][3])
...
for i in all_shop_sum:
    sql = "SELECT COUNT(DISTINCT openid) as '人数' FROM `plus_middle_shop_order`  WHERE is_pay = '1' and  pay_date >= '2019-01-01' and pay_date <= '2019-01-14' AND uniacid = '"+i[0]+"' "
    jingzeng_guanzhu = sql_go.lianjie_sql("plus2test", sql)
    jingzeng_guanzhu_f = float(jingzeng_guanzhu[0][0])
...
jingzeng_guanzhu_f_and=0
for i in all_shop_sum:
    sql = "SELECT COUNT(DISTINCT openid) as '人数' FROM `plus_middle_shop_order`  WHERE is_pay = '1' and   uniacid = '"+i[0]+"' "
    jingzeng_guanzhu = sql_go.lianjie_sql("plus2test", sql)
    jingzeng_guanzhu_f = float(jingzeng_guanzhu[0][0])
    jingzeng_guanzhu_f_and=jingzeng_guanzhu_f+jingzeng_guanzhu_f_and
...
jingzeng_guanzhu_f_and=0
for i in all_shop_sum:
    sql = "SELECT COUNT(DISTINCT openid) as '人数' FROM `plus_middle_shop_order`  WHERE is_pay = '1' and  pay_date >= '2019-01-01'  AND uniacid = '" + i[0] + "' "
    jingzeng_guanzhu=sql_go.lianjie_sql("plus2test",sql)
    jingzeng_guanzhu_f=float(jingzeng_guanzhu[0][0])
    jingzeng_guanzhu_f_and = jingzeng_guanzhu_f + jingzeng_guanzhu_f_and
...
#商品数量
#;
sql="SELECT COUNT(id) FROM `plus_middle_shop_goods` WHERE uniacid in ("+sql_gzh_id_list+") GROUP BY create_date"
goods_sum=sql_go.lianjie_sql("plus2test",sql)
goods_sum_f=float(goods_sum[0][0])
print("商品数量：\t",goods_sum_f,"\t个")


#商品销售数据top10
sql="SELECT SUM(sales_price),good_id FROM `plus_shop_goods_salevisit` WHERE good_id in (SELECT goodsid FROM `plus_middle_shop_goods` WHERE uniacid in ("+sql_gzh_id_list+") )GROUP BY good_id ORDER BY SUM(sales_price) DESC"
...
for goods_sum_sales_price_x in goods_sum_sales_price:
    goods_paihang+=1
    print("排行榜第",goods_paihang,"名--商品id：\t",goods_sum_sales_price[goods_lie][1],"\t商品销售额是：\t",goods_sum_sales_price[goods_lie][0])
    goods_lie+=1
    if goods_lie>=10:
        break
...
sql="SELECT SUM(pay_person_sum)/SUM(visit_person_sum)*100 as '访客到付款转化率' FROM `plus_shop_sale_visit` WHERE uniacid = '1547028602' and type ='1' and create_date >= '2019-01-10' AND create_date <= '2019-01-16'"
fangwen_all3=sql_go.lianjie_sql("plus2test",sql)
for fangwen_x3 in fangwen_all3:
    print("该公众号id访客到付款转化率\t",fangwen_x3[0],"%")
sql="SELECT SUM(pay_person_sum) as '支付人数',SUM(visit_person_sum) as '访客人数',SUM(pay_person_sum)/SUM(visit_person_sum)*100 as '访客到付款转化率',create_date FROM `plus_shop_sale_visit` WHERE uniacid = '1547028602' and type ='1' and create_date >= '2019-01-10' AND create_date <= '2019-01-16' GROUP BY create_date"
fangwen_all2=sql_go.lianjie_sql("plus2test",sql)
for fangwen_x2 in fangwen_all2:
    print("日期:\t", fangwen_x2[3],"该公众号id支付人数:\t",fangwen_x2[0],"人","该公众号id访客人数:\t", fangwen_x2[1], "人","该公众号id访客到付款转化率:\t", fangwen_x2[2], "%")
...
sql="SELECT SUM(sale_prices) as '付款金额',SUM(pay_order_sum) as '付款订单数',SUM(pay_person_sum) as '付款人数',SUM(pay_person_sum)/SUM(order_person_sum)*100 as '下单付款转化率',SUM(visit_person_sum) as '访客人数',SUM(pay_person_sum)/SUM(visit_person_sum)*100 as '访客付款转化率'," \
    "SUM(order_person_sum) as '下单人数',SUM(order_sum) as '下单次数',SUM(order_person_sum)/SUM(visit_person_sum)*100 as '访客下单转化率',SUM(order_prices) as '订单金额' FROM plus_shop_sale_visit where create_date >='2019-01-14' AND create_date <='2019-01-16' AND  uniacid in  ("+sql_gzh_id_list+")"
...
# 小程序交易分析
sql="SELECT SUM(sale_prices) as '付款金额',SUM(pay_order_sum) as '付款订单数',SUM(pay_person_sum) as '付款人数',SUM(pay_person_sum)/SUM(order_person_sum)*100 as '下单付款转化率',SUM(visit_person_sum) as '访客人数',SUM(pay_person_sum)/SUM(visit_person_sum)*100 as '访客付款转化率'," \
    "SUM(order_person_sum) as '下单人数',SUM(order_sum) as '下单次数',SUM(order_person_sum)/SUM(visit_person_sum)*100 as '访客下单转化率',SUM(order_prices) as '订单金额' FROM plus_shop_sale_visit where create_date >='2019-01-14' AND create_date <='2019-01-16' AND type ='1' AND  uniacid in  ("+sql_gzh_id_list+")"
...
# 公众号交易分析
sql="SELECT SUM(sale_prices) as '付款金额',SUM(pay_order_sum) as '付款订单数',SUM(pay_person_sum) as '付款人数',SUM(pay_person_sum)/SUM(order_person_sum)*100 as '下单付款转化率',SUM(visit_person_sum) as '访客人数',SUM(pay_person_sum)/SUM(visit_person_sum)*100 as '访客付款转化率'," \
    "SUM(order_person_sum) as '下单人数',SUM(order_sum) as '下单次数',SUM(order_person_sum)/SUM(visit_person_sum)*100 as '访客下单转化率',SUM(order_prices) as '订单金额' FROM plus_shop_sale_visit where create_date >='2019-01-14' AND create_date <='2019-01-16' AND type ='2' AND  uniacid in  ("+sql_gzh_id_list+")"
...
#交易构成-是否小程序
data="create_date >='2019-01-11' AND create_date <='2019-01-17'"
...
jiaoyigoucheng_all_and_xx=float(jiaoyigoucheng_all_and[0][0])
...
#省份排行：
data="create_date >= '2019-01-11' AND create_date <= '2019-01-17' AND"
...
#访问量日期
sql="SELECT create_date,SUM(visit_person_sum) FROM `plus_shop_sale_visit` WHERE uniacid in (SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')) GROUP BY create_date"
...
sql="SELECT create_date,SUM(visit_person_sum),IF(type='1','小程序','公众号') FROM `plus_shop_sale_visit` WHERE uniacid in (SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM `plus_users` as a WHERE group_id ='1016')) GROUP BY create_date,type"
...
for dianpu_paihang in dianpu_paihang_all:
    print("全部排行第",paihang_s,"的店铺是：\t",dianpu_paihang[0],"\t属于：\t", dianpu_paihang[1],"\t付款金额：\t", dianpu_paihang[2])
    paihang_s+=1

#小程序排行榜
sql="SELECT uniacid,visit_total as '累计用户数' ,session_cnt as '打开次数',visit_uv_new as '新增访问人数',share_uv as '转发人数' FROM `plus_wxapp_visit` WHERE uniacid in(SELECT uniacid FROM plus_shop_info WHERE user_id in (SELECT user_id FROM plus_users WHERE group_id ='1016'))and create_date = '2019-01-17' ORDER BY visit_total DESC "
dianpu_paihang_xiao_xiao=sql_go.lianjie_sql("plus2test",sql)
paihang_s=1
for dianpu_paihang_xiao in dianpu_paihang_xiao_xiao:
    print("小程序排行第",paihang_s,"的店铺是：\t",dianpu_paihang_xiao[0],"\t累计用户数：\t", dianpu_paihang_xiao[1],"\t打开次数：\t", dianpu_paihang_xiao[2],"\t新增访问人数：\t", dianpu_paihang_xiao[2],"\t转发人数：\t", dianpu_paihang_xiao[2])
    paihang_s+=1
...
SELECT user_id FROM plus_users WHERE group_id ='1016'
))
