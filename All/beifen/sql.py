...
class sql():
    def lianjie_sql(self,sql_ip,sql_name,sql_pasword,sql_shujuku_name,sql_yuju):
        self.sql_ip=sql_ip
        ...
        # 打开数据库连接
        db=pymysql.connect(self.sql_ip,self.sql_name,self.sql_paword,self.sql_shujuku_name,charset='utf8')
